...
- Use OIDC end_session_endpoint for RP-initiated logout (#59)

## [0.14.3] - 2026-07-30

### Added

- Enrich api request logs with context and semantic events (#57)

### Fixed

- Derive logout redirect origin from NEXTAUTH_URL (#58)

## [0.14.2] - 2026-07-30

### Fixed

- Pin PORT and HOSTNAME in deployment, cannot be shadowed by secrets (#56)

## [0.14.1] - 2026-07-30

### Fixed

- Make prisma migrate deploy work in the initContainer (#55)

## [0.14.0] - 2026-07-30

### Added

- Migrate to Prisma 7 with pg driver adapter (#54)

### Miscellaneous

- Bump typescript from 5.8.3 to 6.0.3 (#26)
...
[0.14.1]: https://github.com/kuehnleon/daydesk/compare/v0.14.0...v0.14.1
[0.14.0]: https://github.com/kuehnleon/daydesk/compare/v0.13.0...v0.14.0
